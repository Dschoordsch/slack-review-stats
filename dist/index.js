...
const ms_1 = __importDefault(__nccwpck_require__(992));
const dayjs_1 = __importDefault(__nccwpck_require__(401));
const isoWeek_1 = __importDefault(__nccwpck_require__(929));
...
class ReviewStats {
    constructor(options) {
        this.fetchData = (mergedAfter) => __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield fetch(GITHUB_ENDPOINT, {
                method: 'POST',
                headers: {
        ...
        this.pushToSlack = (body) => __awaiter(this, void 0, void 0, function* () {
            const response = yield fetch(this.slackWebhook, {
                method: 'POST',
...
const ReviewStats_1 = __importDefault(__nccwpck_require__(587));
function run() {
